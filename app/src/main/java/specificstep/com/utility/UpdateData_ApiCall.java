...
public class UpdateData_ApiCall {
    ...
    public UpdateData_ApiCall(Context context) {

        this.context = context;
        progressBar = new ProgressDialog(context);
        progressBar.setTitle("Update data...");
...
//            }
    ...
    private void displayErrorDialog_Logout(String message) {
        /* [START] - 2017_05_01 - Close all alert dialog logic */
//        try {
//            alertDialog_Logout = new AlertDialog.Builder(context)
//                    .setTitle("Info!")
