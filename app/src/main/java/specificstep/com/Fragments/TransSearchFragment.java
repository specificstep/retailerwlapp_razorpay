...
public class TransSearchFragment extends Fragment implements View.OnClickListener, SearchListAdapter.SubmitComplainClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        searchListAdapter = new SearchListAdapter(getContextInstance(), rechargeArrayList, this, "Transaction Search");
    ...
    public boolean valid() {
        ...
        if (str_selected_month.contains("Select Month")) {
            ...
            if (edtMobile.getText().toString().length() < 10) {
                Utility.toast(getContextInstance(), "Please enter valid mobile no");
                return false;
            } else {
                return true;
            }
