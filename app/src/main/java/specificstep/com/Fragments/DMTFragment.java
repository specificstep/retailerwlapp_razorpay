...
public class DMTFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mainActivity().getSupportActionBar().setTitle("Sender Search");
        initialize();
    ...
    public void initialize() {
        ...
        edtMobile = (EditText) view.findViewById(R.id.edtDMTMobile);
        btnSearch = (Button) view.findViewById(R.id.btnDMTSearch);
    ...
    public boolean valid() {
        ...
        if(TextUtils.isEmpty(edtMobile.getText().toString())) {
            Toast.makeText(getActivity(),"Please enter Sender Mobile No.",Toast.LENGTH_LONG).show();
            return false;
