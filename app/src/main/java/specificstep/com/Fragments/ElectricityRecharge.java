 ...
 */
public class ElectricityRecharge extends Fragment {
    ...
    public ElectricityRecharge() {
        // Required empty public constructor
    }

    private Context getContextInstance() {
        if (context == null) {
            context = ElectricityRecharge.this.getActivity();
            return context;
        } else {
            return context;
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_electricity_recharge, container, false);
