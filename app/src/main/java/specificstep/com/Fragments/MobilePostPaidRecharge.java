...
public class MobilePostPaidRecharge extends Fragment {
    ...
    public MobilePostPaidRecharge() {
        // Required empty public constructor
    }

    private Context getContextInstance() {
        if (context == null) {
            context = MobilePostPaidRecharge.this.getActivity();
            return context;
        } else {
            return context;
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_mobile_post_paid_recharge, container, false);
        mainActivity().getSupportActionBar().setTitle("Mobile Postpaid Bill Pay");
