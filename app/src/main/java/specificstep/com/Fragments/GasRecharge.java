 ...
 */
public class GasRecharge extends Fragment {
    ...
    private Context getContextInstance() {
        if (context == null) {
            context = GasRecharge.this.getActivity();
            return context;
        } else {
            return context;
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_gas_recharge2, container, false);
        mainActivity().getSupportActionBar().setTitle("Gas Bill Pay");
